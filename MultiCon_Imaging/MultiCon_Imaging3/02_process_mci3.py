...
# %%
## Set parameters
todays_mazes = pd.read_csv('../../../MultiCon_Imaging/MultiCon_Imaging3/maze_yml/todays_mazes.csv')
todays_mazes_type2 = pd.read_csv('../../../MultiCon_Imaging/MultiCon_Imaging3/maze_yml/todays_mazes_type2.csv')
behavior_path = os.path.abspath("../../../MultiCon_Imaging/MultiCon_Imaging3/circletrack_data/")
output_path = os.path.abspath("../../../MultiCon_Imaging/MultiCon_Imaging3/output/behav")
