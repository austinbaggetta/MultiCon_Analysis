...
minian_path = os.path.abspath('../MultiCon_Imaging/MultiCon_Imaging2/minian_results')
output_path = os.path.abspath('../MultiCon_Imaging/MultiCon_Imaging2/output')
session_type = 'C'
# for mouse in os.listdir(minian_path):
for mouse in ['mc23', 'mc26']:
