...
# %%
## Set parameters
starting_idx = 4 ## can use to specify which days you want processed
parent_dir = 'CircleTrack_Inhibition'
experiment_dir = 'Inhibition1'
...
cohort_name = 'inh1'
mouse_list = [f'inh0{x}' for x in np.arange(2, 9)]
str2match = "(inh[0-9]+)" ## Set str2match variable (regex for mouse name)
