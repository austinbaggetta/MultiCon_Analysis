...
# %%
## Set parameters
todays_mazes = pd.read_csv('../../../AD_Updating/AD_Updating1/maze_yml/todays_mazes.csv')
behavior_path = os.path.abspath("../../../AD_Updating/AD_Updating1/circletrack_data/")
output_path = os.path.abspath("../../../AD_Updating/AD_Updating1/output/behav")
if not os.path.exists(output_path):
    os.makedirs(output_path)
cohort_number = 'ad_up1'
