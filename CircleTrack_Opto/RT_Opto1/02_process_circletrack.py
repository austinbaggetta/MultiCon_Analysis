...
# %%
## Set parameters
starting_idx = 10 ## can use to specify which days you want processed
...
cohort_name = 'rto1'
mouse_list = [f'rto0{x}' for x in np.arange(2, 5)] + [f'rto0{x}' for x in np.arange(6, 10)] + ['rto10', 'rto11']
