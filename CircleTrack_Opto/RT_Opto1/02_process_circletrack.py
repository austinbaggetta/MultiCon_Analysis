...
# %%
## Set parameters
starting_idx = 16 ## can use to specify which days you want processed
...
cohort_name = 'rto1'
mouse_list = [f'rto0{x}' for x in np.arange(2, 5)] + [f'rto0{x}' for x in np.arange(8, 10)] + ['rto10', 'rto11']
