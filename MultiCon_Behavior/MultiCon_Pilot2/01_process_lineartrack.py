...
# %%
## Set parameters
behavior_path = os.path.abspath("../../../MultiCon_Behavior/MultiCon_Pilot2/lineartrack_data/")
output_path = os.path.abspath("../../../MultiCon_Behavior/MultiCon_Pilot2/output/lin_behav")
cohort_number = 'mcp2'
num_days = 4 ## how many days of linear track were run
mouse_list = [f'mcp0{x}' for x in np.arange(1, 10)] + ['mcp10', 'mcp11', 'mcp12']
downsample = False
if downsample:
...
for mouse in mouse_list:
    ...
    for i, session in tqdm(enumerate(np.arange(1, num_days+1)), leave=False): 
        print(session)
