...
# %%
## Set parameters
behavior_path = os.path.abspath("../../../MultiCon_Behavior/MultiCon_Lesion1/lineartrack_data/")
output_path = os.path.abspath("../../../MultiCon_Behavior/MultiCon_Lesion1/output/lin_behav")
