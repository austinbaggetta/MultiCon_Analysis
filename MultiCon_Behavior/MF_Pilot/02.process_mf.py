...
# %%
## Set parameters
todays_mazes = pd.read_csv('../../../MultiCon_Behavior/MF_Pilot/maze_yml/todays_mazes.csv')
behavior_path = os.path.abspath("../../../MultiCon_Behavior/MF_Pilot/circletrack_data/")
output_path = os.path.abspath("../../../MultiCon_Behavior/MF_Pilot/output/behav")
if not os.path.exists(output_path):
    os.makedirs(output_path)
cohort_name = 'mf_pilot'
mouse_list = [f'mf0{x}' for x in np.arange(1, 5)]
downsample = False
if downsample:
