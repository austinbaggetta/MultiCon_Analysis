...
experiment_dir = 'MultiCon_Aging1'
...
cohort_name = 'mc_ag1'
mouse_list = [f'mca0{x}' for x in np.arange(1, 10)] + [f'mca{x}' for x in np.arange(10, 24)]
str2match = "(mca[0-9]+)" ## Set str2match variable (regex for mouse name)
