...
# %%
## Set parameters
todays_mazes = pd.read_csv('../../MultiCon_Behavior/MultiCon_Aging1/maze_yml/todays_mazes.csv')
behavior_path = os.path.abspath("../../MultiCon_Behavior/MultiCon_Aging1/circletrack_data/")
output_path = os.path.abspath("../../MultiCon_Behavior/MultiCon_Aging1/output/behav")
cohort_number = 'cohort0'
mouse_list = ['mca01', 'mca02', 'mca03', 'mca04', 'mca05', 'mca06', 'mca08', 'mca10', 'mca11', 'mca12', 
              'mca13', 'mca14', 'mca15', 'mca16', 'mca19', 'mca20', 'mca21', 'mca22', 'mca23']
downsample = False
if downsample:
